...
rename_firmware() {
    ...
    local search_replace_patterns=(
        ...
        "-friendlyarm_nanopi-neo-plus2-|Friendlyarm_Nanopi-Neo-Plus2"
        "-friendlyarm_nanopi-neo2-|Friendlyarm_Nanopi-Neo2"
        "-friendlyarm_nanopi-r1s-h5-|Friendlyarm_Nanopi-R1s-H5"
